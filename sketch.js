...
ciclistaPrincipal.setCollider ("circle",50,100,750);
ciclistaPrincipal.debug = false;
  
fimdeJogo = createSprite(650,80);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distancia: "+ distancia,1000,30);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    textSize (30);
    fill ("gold");
    text ("Aperte a Tecla 'R' Para Reiniciar o Jogo",400,220);
